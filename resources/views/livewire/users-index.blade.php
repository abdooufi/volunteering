                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-end">
                            ...
                            <!-- <a href="{{route("frontend.associations.showall", [encode_id($user->id)])}}" class="btn btn-success btn-sm mt-1" data-toggle="tooltip" title="{{__('labels.backend.show')}}" target="_blank" ><i class="fas fa-desktop"></i></a>-->
